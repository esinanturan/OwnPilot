 ...
 * Discord UCP Adapter
 *
 * Wraps the existing DiscordChannelAPI with UCP normalize/denormalize support.
...
const DISCORD_CAPABILITIES: UCPChannelCapabilities = {
  channel: 'discord',
  features: new Set([
    'rich_text',
    'markdown',
...
export class DiscordUCPAdapter extends UCPChannelAdapter {
  readonly platform = 'discord';
  readonly capabilities: UCPChannelCapabilities = DISCORD_CAPABILITIES;
  ...
  /**
   * Send a UCPMessage via the Discord API.
