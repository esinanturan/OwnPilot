 ...
 * Slack UCP Adapter
 *
 * Wraps the existing SlackChannelAPI with UCP normalize/denormalize support.
...
const SLACK_CAPABILITIES: UCPChannelCapabilities = {
  channel: 'slack',
  features: new Set([
    'rich_text',
    'markdown',
...
export class SlackUCPAdapter extends UCPChannelAdapter {
  readonly platform = 'slack';
  readonly capabilities: UCPChannelCapabilities = SLACK_CAPABILITIES;
  ...
  /**
   * Send a UCPMessage via the Slack API.
