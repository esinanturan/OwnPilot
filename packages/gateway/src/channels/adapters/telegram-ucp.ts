/**
 * Telegram UCP Adapter
 *
 * Wraps the existing TelegramChannelAPI with UCP normalize/denormalize support.
...
const TELEGRAM_CAPABILITIES: UCPChannelCapabilities = {
  channel: 'telegram',
  features: new Set([
    'rich_text',
    'markdown',
...
export class TelegramUCPAdapter extends UCPChannelAdapter {
  readonly platform = 'telegram';
  readonly capabilities: UCPChannelCapabilities = TELEGRAM_CAPABILITIES;
  ...
  /**
   * Send a UCPMessage via the Telegram API.
